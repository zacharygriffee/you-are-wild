        ...
        const App = {
            ...
            getTile(x, y) {
                ...
                const biomeId = biomeIds[seed % biomeIds.length];
            ...
            exploreTile(x, y) {
                ...
                if (!tile.explored) {
                    ...
                    if (Math.random() < 0.1) {
                        const landmarks = { forest: ['Ancient Tree','Fairy Ring','Hunter\'s Camp'], swamp: ['Sunken Shrine','Witch\'s Hut','Bone Pile'], plains: ['Lone Tree','Abandoned Wagon','Stone Circle'], cave: ['Crystal Chamber','Underground Lake','Collapsed Tunnel'], jungle: ['Waterfall','Hidden Pool','Rope Bridge'] };
