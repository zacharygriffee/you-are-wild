...
const YAW_ACTION_UI = {
    ...
    combatIntentButton(app, key, actor, extraClass = '') {
        ...
        return app._iconActionButton(key, app._actionIcon(key), `event.stopPropagation();App.executeCombatIntent('${key}')`, classes, `data-command-surface="combat-intents" data-command-mode="combat" data-command-intent="${intent}" data-command-grammar="actor-target-intent"`);
    },
