...
const CONTENT_SYSTEM = {
    ...
    locales: {
        en: {
            ...
            'target.chooseOneActor': 'Choose one actor for multi-target {action} actions, or one target for group actions.',
        ...
        es: {
            ...
            'target.chooseOneActor': 'Elige un actor para acciones multiobjetivo de {action}, o un objetivo para acciones grupales.',
