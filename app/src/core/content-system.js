...
const CONTENT_SYSTEM = {
    ...
    locales: {
        en: {
            ...
            'combat.panelFirstStatus': 'Combat controls',
            'combat.panelFirstPrompt': 'Use the active actor card for combat intent, then pick a target in the enemy panel.',
            'combat.panelFirstTargeting': 'Targeting: {action}. Pick a valid target in the enemy panel.',
            'combat.panelFirstEnemyTurn': '{name} is acting. Combat controls stay in the party and creature panels.',
        ...
        es: {
            ...
            'combat.panelFirstStatus': 'Controles de combate',
            'combat.panelFirstPrompt': 'Usa la carta del actor activo para elegir la intencion, luego elige un objetivo en el panel enemigo.',
            'combat.panelFirstTargeting': 'Objetivo de {action}. Elige un objetivo valido en el panel enemigo.',
            'combat.panelFirstEnemyTurn': '{name} esta actuando. Los controles de combate permanecen en los paneles de grupo y criaturas.',
