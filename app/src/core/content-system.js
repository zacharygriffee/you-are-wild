...
const CONTENT_SYSTEM = {
    ...
    locales: {
        en: {
            ...
            'save.slotHint.occupiedLoad': 'Saved slot: load, start a new run, save over, or delete this slot only.',
        ...
        es: {
            ...
            'save.slotHint.occupiedLoad': 'Slot guardado: carga, inicia una nueva partida, guarda encima o borra solo este slot.',
