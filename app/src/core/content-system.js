...
const CONTENT_SYSTEM = {
    ...
    locales: {
        en: {
            ...
            'ui.tutorial.combat.content': 'In combat, you take turns with enemies and allies. Use Fight, Flirt, Fuck, Feast, Feed, or Flee. Sync actions let multiple allies act together.',
            'ui.tutorial.feast.title': 'Feast',
            'ui.tutorial.feast.content': 'Feast on weakened targets to contain them. Capacity matters, and some settings change whether outcomes are safe or harsher.',
            ...
            'ui.swipeRightMap': 'Swipe right for map',
            'ui.swipeLeftParty': 'Swipe left for party',
            ...
            'recruit.confirmSubmissive': '{name} is submissive. Recruit them to your party?',
            ...
            'party.aiOrderDescription.scavenger': 'Looks for corpse-feast opportunities after victory.',
            ...
            'target.chooseOneActor': 'Choose one actor for multi-target {action} actions, or one target for group {action} actions.',
            ...
            'explore.fuck.success': '{actor} pleasures {target}. Their arousal rises to {current}/{max}.',
            'explore.fuck.devoted': '{target} orgasms and is completely devoted.',
            'explore.fuck.recover': '{target} needs a moment to recover...',
            'explore.fuck.resists': '{target} is not in the mood.',
            'explore.feast.swallow': '{actor} swallows {target} whole. They settle in {owner} stomach.',
            'explore.feast.tooStrong': '{target} is too large or strong to eat.',
            'explore.flirt.success': '{actor} flirts with {target}. Their guard lowers. Pleasure rises to {current}/{max}.',
            'explore.flirt.charmed': '{target} is utterly charmed and becomes friendly!',
            'explore.flirt.rebuff': '{target} rebuffs the flirtation!',
            ...
            'group.feed.partyToConsumer': '{prey} is fed to {consumer} and settles in their stomach.',
            ...
            'group.feast.selfBlocked': '{target} cannot feast on themself. Select other party members as actors to consume this target, or select {target} alone to feast on another target.',
            'group.feast.tooStrong': '{target} is too large or strong for {actors} to consume.',
            'group.feast.swallow': '{helpers} help {primary} swallow {target}.',
            'group.social.share': '{actors} share {action} with {target}. Pleasure spreads through the group; {target} rises to {current}/{max}.',
            'group.social.focus': '{actors} focus on {target}. Pleasure rises to {current}/{max}.',
        ...
        es: {
            ...
            'ui.tutorial.combat.content': 'En combate, tomas turnos con enemigos y aliados. Usa Luchar, Coquetear, Seducir, Devorar, Alimentar o Huir. Las acciones sincronizadas permiten que varios aliados actuen juntos.',
            'ui.tutorial.feast.title': 'Devorar',
            'ui.tutorial.feast.content': 'Devora objetivos debilitados para contenerlos. La capacidad importa, y algunos ajustes cambian si los resultados son seguros o mas duros.',
            ...
            'ui.swipeRightMap': 'Desliza a la derecha para ver el mapa',
            'ui.swipeLeftParty': 'Desliza a la izquierda para ver el grupo',
            ...
            'recruit.confirmSubmissive': '{name} esta sumiso. Reclutarlo para tu grupo?',
            ...
            'party.aiOrderDescription.scavenger': 'Busca oportunidades con restos despues de la victoria.',
            ...
            'target.chooseOneActor': 'Elige un actor para acciones multiobjetivo de {action}, o un objetivo para acciones grupales de {action}.',
            ...
            'explore.fuck.success': '{actor} complace a {target}. Su placer sube a {current}/{max}.',
            'explore.fuck.devoted': '{target} llega al climax y queda completamente entregado.',
            'explore.fuck.recover': '{target} necesita un momento para recuperarse...',
            'explore.fuck.resists': '{target} no esta de humor.',
            'explore.feast.swallow': '{actor} traga a {target} entero. Queda en el estomago de {owner}.',
            'explore.feast.tooStrong': '{target} es demasiado grande o fuerte para comer.',
            'explore.flirt.success': '{actor} coquetea con {target}. Baja la guardia. El placer sube a {current}/{max}.',
            'explore.flirt.charmed': '{target} queda totalmente encantado y se vuelve amistoso!',
            'explore.flirt.rebuff': '{target} rechaza el coqueteo!',
            ...
            'group.feed.partyToConsumer': '{prey} es alimentado a {consumer} y queda en su estomago.',
            ...
            'group.feast.selfBlocked': '{target} no puede devorarse a si mismo. Selecciona otros miembros del grupo como actores para consumir este objetivo, o selecciona solo a {target} para devorar otro objetivo.',
            'group.feast.tooStrong': '{target} es demasiado grande o fuerte para que {actors} lo consuman.',
            'group.feast.swallow': '{helpers} ayudan a {primary} a tragar a {target}.',
            'group.social.share': '{actors} comparten {action} con {target}. El placer se extiende por el grupo; {target} sube a {current}/{max}.',
            'group.social.focus': '{actors} se enfocan en {target}. El placer sube a {current}/{max}.',
