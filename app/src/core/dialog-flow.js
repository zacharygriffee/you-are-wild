...
const YAW_DIALOG_FLOW = {
    showConfirm(app, options = {}) {
        ...
        const html = `<div class="app-confirm-backdrop" id="app-confirm-dialog" role="dialog" aria-modal="true" aria-labelledby="app-confirm-title" aria-describedby="app-confirm-message" data-command-surface="system-dialog" data-command-mode="system"><div class="app-confirm-card" data-command-surface="system-dialog" data-command-mode="system"><h3 id="app-confirm-title">${app._escapeHtml(title)}</h3><p id="app-confirm-message">${app._escapeHtml(message)}</p><div class="app-confirm-actions" data-command-surface="system-dialog" data-command-mode="system"><button class="nav-btn" data-command-surface="system-dialog" data-command-mode="system" data-command-control="cancel-dialog" onclick="App.resolveConfirmDialog(false)">${app._escapeHtml(cancelLabel)}</button><button class="nav-btn primary${dangerClass}" data-command-surface="system-dialog" data-command-mode="system" data-command-control="confirm-dialog" onclick="App.resolveConfirmDialog(true)">${app._escapeHtml(confirmLabel)}</button></div></div></div>`;
