...
const YAW_SUB_ACTIONS = {
    ...
    definitions: {
        feast: {
            ...
            chew: { label: 'Chew', sfwLabel: 'Break Down', icon: '🦷', validate: (a, t) => a !== t && App.settings.chewing, execute: 'chewPrey', setting: 'chewing', settingLabelKey: 'settings.variant.chewing', hintKey: 'feast.chewHint', hint: 'Vitality attack: removed body mass nourishes the chewer and damage also reduces punishment. A survivor may flee or fight.', minPosture: 'mature', requirements: ['reach', 'cost'] },
