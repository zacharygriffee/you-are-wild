...
test('Multiple actors against multiple marked targets are rejected clearly', () => {
  ...
  assertContains(App.log[App.log.length - 1].text, 'Elige un actor para acciones multiobjetivo de coquetear', 'Many-to-many rejection should localize how to proceed');
});
