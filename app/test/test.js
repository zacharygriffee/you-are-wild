...
test('Unit cards and mobile chips render compact tactical bars accessibly', () => {
  ...
  assertContains(partyCard, 'aria-haspopup="dialog" onclick="event.stopPropagation();App.showIntentMenu(\'party\',0)', 'Party action menu button should advertise its dialog popup');
  ...
  assertContains(creatureCard, 'aria-haspopup="dialog" onclick="event.stopPropagation();App.showIntentMenu(\'creature\',\'fox-1\')', 'Creature action menu button should advertise its dialog popup');
  ...
  assertContains(mobilePartyChip, 'aria-haspopup="dialog" onclick="event.stopPropagation();App.showIntentMenu(\'party\',0)', 'Mobile party action menu button should advertise its dialog popup');
  assertContains(mobileCreatureChip, 'aria-haspopup="dialog" onclick="event.stopPropagation();App.showIntentMenu(\'creature\',\'fox-1\')', 'Mobile creature action menu button should advertise its dialog popup');
