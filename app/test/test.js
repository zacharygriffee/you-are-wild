    ...
    localStorage,
    {
      ...
      locales: {
        ...
        es: {
          ...
          'save.toolbarNew': 'Nueva partida', 'save.toolbarHint': 'Elige un slot despues; los slots ocupados avisan antes de sobrescribir.', 'save.slotLabel': 'Slot {number}', 'save.savedGame': 'Partida guardada', 'save.openSlot': 'Slot abierto', 'save.empty': 'Vacio', 'save.slotHint.emptyLoad': 'Slot vacio: inicia una partida nueva aqui.', 'save.slotHint.occupiedLoad': 'Slot guardado: carga, inicia una nueva partida o borra solo este slot.', 'save.slotHint.emptySave': 'Slot vacio: guarda la partida actual aqui.', 'save.slotHint.occupiedSave': 'Slot ocupado: guardar aqui puede requerir confirmacion para sobrescribir.', 'save.slotHint.emptyNew': 'Slot vacio: listo para una nueva partida.', 'save.slotHint.occupiedNew': 'Slot ocupado: sobrescribir requiere confirmacion.', 'save.useEmpty': 'Usar slot vacio', 'save.overwriteSlot': 'Sobrescribir slot',
