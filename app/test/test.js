    ...
    localStorage,
    {
      ...
      locales: {
        ...
        es: {
          ...
          'disposition.hostile': 'Hostil', 'disposition.friendly': 'Amistoso', 'disposition.neutral': 'Neutral', 'disposition.quest': 'Mision', 'disposition.merchant': 'Mercader', 'disposition.remains': 'Restos', 'combat.row': 'Fila', 'combat.row.front': 'Frente', 'combat.row.back': 'Retaguardia', 'combat.moveRowLog': '{name} se mueve a la fila {row}.', 'capacity.stomach': 'Estomago', 'capacity.womb': 'Vientre', 'capacity.balls': 'Bolas',
