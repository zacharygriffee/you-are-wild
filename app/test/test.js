    ...
    localStorage,
    {
      ...
      locales: {
        en: {
          ...
          'save.toolbarNew': 'New Game', 'save.toolbarHint': 'Choose a slot next; occupied slots warn before overwrite.', 'save.slotLabel': 'Slot {number}', 'save.savedGame': 'Saved game', 'save.openSlot': 'Open slot', 'save.empty': 'Empty', 'save.slotHint.emptyLoad': 'Empty slot: start a new game here.', 'save.slotHint.occupiedLoad': 'Saved slot: load, start a new run, save over, or delete this slot only.', 'save.slotHint.emptyNew': 'Empty slot: ready for a new run.', 'save.slotHint.occupiedNew': 'Occupied slot: overwriting requires confirmation.', 'save.useEmpty': 'Use Empty Slot', 'save.overwriteSlot': 'Overwrite Slot',
        ...
        es: {
          ...
          'save.toolbarNew': 'Nueva partida', 'save.toolbarHint': 'Elige un slot despues; los slots ocupados avisan antes de sobrescribir.', 'save.slotLabel': 'Slot {number}', 'save.savedGame': 'Partida guardada', 'save.openSlot': 'Slot abierto', 'save.empty': 'Vacio', 'save.slotHint.emptyLoad': 'Slot vacio: inicia una partida nueva aqui.', 'save.slotHint.occupiedLoad': 'Slot guardado: carga, inicia una nueva partida, guarda encima o borra solo este slot.', 'save.slotHint.emptyNew': 'Slot vacio: listo para una nueva partida.', 'save.slotHint.occupiedNew': 'Slot ocupado: sobrescribir requiere confirmacion.', 'save.useEmpty': 'Usar slot vacio', 'save.overwriteSlot': 'Sobrescribir slot',
...
test('Unequal actors against marked targets are rejected clearly', () => {
  ...
  assertContains(App.log[App.log.length - 1].text, 'Elige un actor para acciones multiobjetivo de coquetear, o un objetivo para acciones grupales de coquetear.', 'Unequal many-to-many rejection should localize both correction paths');
});
...
test('Save manager renders localized accessible slot actions', () => {
  ...
  assertContains(html, 'Slot guardado: carga, inicia una nueva partida, guarda encima o borra solo este slot.', 'Occupied load-mode slot hint should localize');
