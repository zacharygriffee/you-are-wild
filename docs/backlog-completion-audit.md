...
| --- | --- | --- |
| Mobile Interaction Flow V2 public UI slots | Accepted unified Roster sheet and persistent context composer; current responsive/accessibility matrices and `docs/mobile-interaction-flow-v2-decision.md` | Complete rendered V2 acceptance before freezing or exposing the bounded public slot names |
