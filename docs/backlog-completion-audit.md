...
| Delivery | Full build, viewport, interaction, branding, artifact, and diff gates | 0.18.1 was published as a select-group alpha after exact-candidate CI, rollback selection, and operator authorization. Repeat the same gates for every patch. |
