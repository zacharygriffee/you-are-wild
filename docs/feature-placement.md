...
| Contextual action-variant orchestrator | Composer, action registry, reach/capacity previews, accessibility, group plans, mod APIs | Medium | Safe-capable with tier-filtered variants | V1 shared resolver and desktop/mobile surface preserve `InteractionPlan.subAction`; module registration is permissioned and owned | Future: richer pair-by-pair group previews and authored variant-specific cost models |
