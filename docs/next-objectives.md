...
- **Build:** 173/173 tests pass, 10/10 lint modules clean, dist fresh
...
FightFuckFeed.tactical/
  src/core/
    app.js           — Main game state, combat loop, encounter system, AI (~5695 lines)
  ...
  test/test.js       — 173 tests, syntax/structure/combat behavior
