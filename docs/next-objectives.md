...
- **Build:** 220/220 tests pass, 10/10 lint modules clean, dist fresh
...
- Continue auditing lower-traffic custom controls for keyboard focus order, visible focus, and complete `aria-label` coverage; high-traffic mobile unit-chip actions now expose localized accessible names
