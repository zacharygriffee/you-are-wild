...
- Persistent shell localization now has a reusable `data-i18n` pass for static text, titles, accessible labels, and placeholders; the main menu, top navigation, dynamically injected Settings/Market/Mods nav buttons, log controls, action legends, and core settings shell opt into English/Spanish relabeling when the language changes
