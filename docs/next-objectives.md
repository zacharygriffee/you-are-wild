...
- **Build:** 182/182 tests pass, 10/10 lint modules clean, dist fresh
...
FightFuckFeed.tactical/
  src/core/
    app.js           — Main game state, combat loop, encounter system, AI (~6000 lines)
  ...
  test/test.js       — 182 tests, syntax/structure/combat behavior
